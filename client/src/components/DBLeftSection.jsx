...
const DBLeftSection = () => {
  return (
    <div className="h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-210 w-300 gap-3">
      <NavLink to={"/"} className="flex items-center justify-start px-6 gap-0">
      ...
      items-center justify-center flex-col gap-3 px-3"
        >
          ...
          <p className="text-xl text-primary font-semibold">
            Having trouble in this web site. Please contact us for more
            questions
          </p>
          <p className="px-4 py-1 rounded-full bg-primary text-red-400 cursor-pointer">
            Get in touch
          </p>
        </div>
      </div>
