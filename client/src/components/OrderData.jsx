...
const OrderData = ({ index, data, admin }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full flex flex-col items-center justify-start px-3 py-2 border relative border-gray-300 bg-lightOverlay drop-shadow-md rounded-md gap-4"
    >
      <div className="w-full flex items-center justify-between">
        <h1 className=" text-xl text-headingColor font-semibold">Orders</h1>
        <div className="flex items-center gap-4">
          <p className=" flex items-center gap-1 text-textColor">
            Total : <span className=" text-lg text-red-500">Rs. </span>
              ...
              >
                ...
                <div className="flex items-start flex-col">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <p className="flex items-center gap-1 text-textColor">
                      <span className="text-base text-red-500">Rs. </span>
